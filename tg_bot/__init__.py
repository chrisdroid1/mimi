...
class KigyoINIT:
    def __init__(self, parser):
        ...
        self.CUSTOM_CMD = ['/', '!']
        self.ASSISTANT_NAME = self.parser.getenv("ASSISTANT_NAME", "DaisyXhelper")
        self.SUPPORT_GROUP = self.parser.getenv("SUPPORT_GROUP", "DaisySupport_Official")
        self.PROJECT_NAME = self.parser.getenv("PROJECT_NAME", "DaisyXMusic v4")
        self.DURATION_LIMIT = self.parser.int(getenv("DURATION_LIMIT", "7"))
        self.ARQ_API_KEY = self.parser.getenv("ARQ_API_KEY", None)
...
PORT = KInit.PORT
SESSION_NAME = KInit.SESSION_NAME
UPDATES_CHANNEL = KInit.UPDATES_CHANNEL
BG_IMAGE = KInit.BG_IMAGE
ASSISTANT_NAME = KInit.ASSISTANT_NAME
SUPPORT_GROUP = KInit.SUPPORT_GROUP
PROJECT_NAME = KInit.PROJECT_NAME
DURATION_LIMIT = KInit.DURATION_LIMIT
